...
import { DeleteUserModalProps } from '../types/userTypes';
      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        ...
        <div className="mb-6">
          <p className="text-gray-600 mb-4">
            <strong>{user.name}</strong> kullanıcısını ve tüm projelerini kalıcı olarak silmek istediğinizden emin misiniz?
          </p>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Onaylamak için kullanıcının adını tam olarak yazın: <strong>{user.name}</strong>
            </label>
            <input
              type="text"
