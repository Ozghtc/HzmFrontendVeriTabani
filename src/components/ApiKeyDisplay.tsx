    ...
    return (
      <div className="bg-white rounded-lg border border-gray-200 p-6 text-center text-gray-500">
        <div className="flex flex-col items-center">
          ...
          <h2 className="text-lg font-semibold text-gray-700 mb-2">API Key veya Proje Bilgisi Bulunamadı</h2>
          <p className="text-gray-500 mb-2">Bu projeye ait API Key veya proje verisi eksik. Lütfen önce bir proje oluşturun veya seçin.</p>
        </div>
      </div>
    );
  }
